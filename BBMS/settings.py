"""
Django's settings for BBMS project.
...
SECRET_KEY = 'django-insecure-5#_blz8^3tzs1@eu&+^kby8qt-iwusr5a50*q7+$v%!exm-%n='
...
STATICFILES_DIRS = [BASE_DIR, 'BBMS_APP/static']
